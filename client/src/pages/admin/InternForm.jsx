...
export default function InternForm() {
  ...
  return (
    <DashboardLayout title={isEdit ? 'Edit Intern' : 'Register New Intern'}>
      <form onSubmit={handleSubmit} className="card" style={{ maxWidth: 900 }}>
        ...
        <div className="grid grid-cols-3 mb-3">
          ...
          <div className="form-group"><label>{isEdit ? 'Reset Password (optional)' : 'Password (default: Intern@123)'}</label><input type="password" value={form.password} onChange={update('password')} /></div>
        </div>
        ...
        <div className="flex gap-2 mt-3">
          <button className="btn btn-primary" disabled={saving}>{saving ? 'Saving...' : 'Save Intern'}</button>
